...
def debian():
   ...
   if check_tdm_gcc ==True:
      ...
      if install_gcc_wine =='yes':
         os.system('apt update && apt install wget -y && wget https://sourceforge.net/projects/tdm-gcc/files/TDM-GCC Installer/tdm64-gcc-5.1.0-2.exe')
         os.system('mv tdm64-gcc-5.1.0-2.exe tdmgcc.exe')
         os.system('wine tdmgcc.exe')
